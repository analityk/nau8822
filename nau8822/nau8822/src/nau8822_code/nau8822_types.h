...
enum e_left_input_mixer_srcs{ e_lim_LeftMic, e_lim_LeftLine, e_lim_LeftAux };
enum e_right_input_mixer_srcs{ e_rim_RightMic, e_rim_RightLine, e_rim_RightAux };
enum e_left_main_mixer_srcs{ e_lmm_LeftAux, e_lmm_LeftInputMixer, e_lmm_LeftDAC, e_lmm_RightDAC };
enum e_right_main_mixer_srcs{ e_rmm_RightAux, e_rmm_RightInputMixer, e_rmm_RightDAC, e_rmm_LeftDAC };
enum e_aux1mix_srcs{ e_a1m_LeftMainMixer, e_a1m_RightDAC, e_a1m_LeftDAC, e_a1m_RightInputMixer };
// warning - aux2mixer is permanently connected to aux1mixer output
enum e_aux2mix_srcs{ e_a2m_LeftInputMixer, e_a2m_LeftDAC, e_a2m_LeftMainMixer };
enum e_right_submixer_srcs{ e_rs_RightMainMixer, e_rs_RightAux };
...
enum e_equ_src{ e_equ_off, e_es_ADC, e_es_DAC };
...
//typedef struct {
	...
	//s_clock_contorl_1 clock_contorl_1;
